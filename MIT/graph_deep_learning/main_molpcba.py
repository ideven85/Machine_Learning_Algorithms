    ...
    try:
        with tqdm(range(params["epochs"])) as t:
            for epoch in t:
                ...
                epoch_train_loss, epoch_train_ap, optimizer = train_epoch(
                    model,
                    optimizer,
                    device,
                    train_loader,
...
def main():
    ...
    parser.add_argument(
        "--config",
        default="configs/MOLPCBA/optimized",
