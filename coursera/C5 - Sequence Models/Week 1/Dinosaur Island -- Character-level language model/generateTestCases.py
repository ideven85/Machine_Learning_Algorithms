...
mFiles = ["clip.py", "sample.py", "optimize.py", "model.py"]
...
def generateTestCases():
    testCases = {
        "clip": {
            "partId": "sYLqC",
            "testCases": [{"testInput": (gradients1, 10), "testOutput": gradients}],
        },
        "sample": {
            "partId": "QxiNo",
            "testCases": [
                {"testInput": (parameters, char_to_ix, 0), "testOutput": indexes}
            ],
        },
        "optimize": {
            "partId": "x2pxm",
        ...
        "model": {
            "partId": "mJTOb",
            "testCases": [
                {"testInput": (examples, ix_to_char, char_to_ix, 200), "testOutput": a}
            ],
        },
    }
    return testCases
