...
![Features](Attachments/B3E2D387-DF59-4EBF-97C2-3126D21C9D13.jpg)  
...
![Features](Attachments/C9A3CE47-0387-462A-9980-7BBF3D404560.png)  
...
![Layer 2](Attachments/3563AD1F-F768-4FD5-B038-E8792F1DFCA1.png)  
...
![upGrad](Attachments/B10AF9E4-29D2-4C21-9521-45F3376ACC65.jpg)  
...
![Features](Attachments/5BAB6A0C-30BC-4BC2-AAD6-9F7EAE0F6E8A.png)  
...
* Generation Layer  
![Embedding Layer](Attachments/FC0CF156-D667-4EFE-B7E7-03E60201810D.png)  
...
![Rag Pipeline.png](Attachments/B58E9E7F-5C94-4334-A638-87801C946322.png)  
...
![Embeding Mode](Attachments/A1E0D804-6067-4E8B-9CDD-BEAA4D25BD55.png)  
...
![image.jpg](Attachments/5E6A59EF-9863-4FA9-AB36-E46352CE3BF2.jpg)  
...
![Stept: Build the Vite Steer](Attachments/33DC6770-F4AE-460C-8193-9D980E1F218F.png)  
...
RAG Demo - Part 2.2: Re-Ranking  So far, you have learned how to implement the semantic search layer with cache. In this segment, we will look at another crucial element to improve the performance of the semantic search layer - re-ranking. Let’s learn more about this from the video below.  
...
![Cross-Encoder](Attachments/9B2B188E-CE63-42B6-85E1-390F91CD55D2.png)  
   
...
![Sina 2i Cache, Searc, Revana](Attachments/546AC0A5-648F-431F-ABB4-D69D6DFC3B40.png)  
...
As mentioned in the video, cross-encoder models are transformer models that can be used to learn the semantic similarity between two text sequences. They are trained on a large data set of text pairs, where each pair is labelled with a score indicating how similar the two sequences are. Once trained, cross-encoder models can be used to compute the similarity between any two text sequences, even if they have never been seen before. The image below illustrates the function of a cross-encoder model.    
![Cross-Encoder](Attachments/DF30BE5F-91D9-43B1-95A8-E5DE06F958C3.png)  
   
There are a number of advantages of using cross-encoder models for re-ranking. First, these models can learn the semantic similarity between text sequences, which is a more accurate measure of relevance than traditional methods, such as keyword matching. Second, cross-encoder models can capture long-range dependencies in text, which can be important for understanding the meaning of a sentence or paragraph. Third, the models can be used to re-rank documents from any domain, without the need for any domain-specific knowledge.  
...
![Sina 2i Cache, Searc, Revana](Attachments/9DC5E7E6-DB0B-4424-B1A2-0CFF2003AB01.png)  
 The final step in our semantic search application is to include a generative AI model capable of generating content in response to the results or contexts passed to it.  
...
![15c48466-8a99-47f5-9e28-8ceff2817e47-A.png](Attachments/9D1C9E33-65C2-4366-BEB1-2AD5A0D6EF9D.png)  
...
![Sats indicates a row.](Attachments/52711B28-EDEE-44D3-BC15-7747E9E71D5B.png)  
...
4. ![Model Response](Attachments/B8D97DC5-9881-4B55-BF40-929D09A17009.png)  
