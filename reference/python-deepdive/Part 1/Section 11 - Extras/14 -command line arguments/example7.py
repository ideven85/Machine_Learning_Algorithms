...
parser = argparse.ArgumentParser(
    description="Returns a string containing person's name and current age."
)
parser.add_argument(
    "-f",
    "--first",
...
parser.add_argument(
    "-l", "--last", help="specify last name", type=str, required=True, dest="last_name"
)
parser.add_argument(
    "--yob", help="year of birth", type=int, required=False, dest="birth_year"
)
