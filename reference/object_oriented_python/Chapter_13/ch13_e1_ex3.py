    ...
    def wheel_app(
        ...
        if environ["REQUEST_METHOD"] == "POST":
            ...
            if size != "0":
                ...
                raise RESTException("403 FORBIDDEN", f"Data {raw!r} not allowed")
...
def roulette_client(
    method: str = "GET", path: str = "/", data: Optional[Dict[str, str]] = None
) -> Response:
...
def server_3() -> None:
    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
        ...
        assert r4.status == 200 and r4.content == {
            "spin": {"9": [35, 1], "Red": [1, 1], "Lo": [1, 1], "Odd": [1, 1]},
            "payout": [["Black", 2, "lose"]],
            "stake": 98,
            "rounds": 1,
        }, f"{r4!r}"
