# Hull Tactical - Market Prediction Project  
...
Blair Hull, Petra Bakosova, Laurent Lanteigne, Aishvi Shah, Euan C Sinclair, Petri Fast, Will Raj, Harold Janecek, Sohier Dane, and Addison   
  
  
Howard. Hull Tactical - Market Prediction. https://kaggle.com/competitions/hull-tactical-market-prediction, 2025. Kaggle.  
...
kaggle_evaluation/ Files used by the evaluation API. See [the demo submission](https://www.kaggle.com/code/sohier/hull-tactical-market-prediction-demo-submission) for an illustration of how to use the API.  
