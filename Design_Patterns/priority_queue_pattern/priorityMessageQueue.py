...
class PriorityMessageQueue:
    ...
    def maxHeapifyDown(self):
        parentIndex= 0;childIndex1=1;childIndex2=2
        while childIndex2<len(self) and  (self.queue[parentIndex].priority <= self.queue[childIndex1].priority
            ...
            self.queue[parentIndex],self.queue[minIndex] = self.queue[minIndex],self.queue[parentIndex]
