...
class Add(BinOp):
    ...
    # def __init__(self,left,right):
    #     if isinstance(left,BinOp) and isinstance(right,BinOp):
    #         super().__init__(left.left,left.right)
    #         super().__init__(right.left,right.right)
    #     elif isinstance(left,BinOp):
    #         super().__init__(left.left,left.right)
    #     elif isinstance(right,BinOp):
    #         super().__init__(right.left,right.right)
    #     else:
